...
const getPhotoName = async (): Promise<string> => {
  if (!props.group.photoFileName) return 'img/no-photo.png'

  try {
    const url = `${API_URL}/uploads/eventGroups/${props.group.photoFileName}`
...
<template>
  ...
  >
    ...
    <!-- Cover image -->
    <div class="border-0.5 mb-4 overflow-hidden">
      <img
        :src="photoSrc"

      ...
      <div class="mb-4 flex flex-row flex-wrap gap-2">
        ...
        >
          ...
          <UButton
            ...
            variant="ghost"
            class="cursor-pointer text-3xl text-gray-900 hover:bg-gray-300/80"
            :class="{
          ...
          <template #h1>
            <UButton
              ...
              variant="ghost"
              class="flex w-full cursor-pointer text-2xl text-gray-900"
              :class="{
                'bg-gray-300/50': editor?.isActive('heading', {
                  level: 1,
                }),
          ...
          <template #h2>
            <UButton
              ...
              variant="ghost"
              class="w-full cursor-pointer text-2xl text-gray-900 hover:bg-gray-300/80"
              :class="{
                'bg-gray-300/50': editor?.isActive('heading', {
                  level: 2,
                }),
        ...
        <div class="relative inline-block">
          ...
          >
            <UButton
              icon="typcn:delete"
              class="absolute top-3 right-3 cursor-pointer bg-red-500 text-lg text-gray-900 hover:bg-red-600"
        ...
        <UDropdownMenu
                      ...
                      :content="{
                      align: 'start',
              side: 'left', // Zmień na lewą stronę, aby menu rozwijało się do środka ekranu
              sideOffset: 8,
        ...
        >
          ...
          <template #insert-table>
            <UButton
              ...
              variant="ghost"
              class="flex w-full cursor-pointer text-3xl text-gray-900 hover:bg-transparent"
              title="Insert table"
              @click="

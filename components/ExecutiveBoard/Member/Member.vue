...
<template>
  ...
  >
    ...
    >
      <img
        class="w-full overflow-hidden rounded-s-lg object-cover object-center"
  ...
  <Teleport to="body">
    ...
    >
      <div
        class="modal-box relative flex h-11/12 max-w-11/12 flex-col bg-white p-0 shadow-2xl lg:h-10/12 lg:max-w-6/12"
      >
        <div
        ...
        >
          <div class="flex h-40 w-32 flex-shrink-0">
            <img
              class="w-full overflow-hidden rounded-tl-lg object-cover object-center"
              alt="Picture of PLAIS executive board member"
              :src="photoSrc"
            />
          </div>
        ...
        <div class="flex justify-end p-5">
          <button
            class="btn border-0 bg-blue-600 text-white hover:bg-blue-800 hover:font-semibold"
            @click.stop="toggleModalAbout"
          >
            Close
          </button>

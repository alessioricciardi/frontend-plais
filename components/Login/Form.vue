...
<template>
  <form @keydown.enter="login">
    <div
      class="flex h-150 w-150 flex-col items-center rounded-3xl bg-white sm:border-1 sm:border-gray-200 sm:shadow-xl"
    >
      <div class="mt-15 size-40 cursor-pointer" @click.stop="router.push('/')">

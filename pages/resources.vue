    ...
    <div class="flex">
      ...
      <div class="flex-1">
        ...
        <div class="flex h-30 items-center justify-center">
          <div class="ml-5 text-4xl font-bold text-gray-900 sm:text-5xl">
            Resources
          </div>
        </div>

        <div v-if="loggedIn" class="mb-5 flex w-full justify-start px-5">
          <ResourcesGroupAdd
            class=""
        ...
        <template v-if="resources">
          <div v-for="resource in resources" :key="resource.id">
            <div v-show="resource.id === selectedCategory">
              <div class="mx-5 mb-20 flex flex-col gap-5">
